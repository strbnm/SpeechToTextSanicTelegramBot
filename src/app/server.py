...
async def handler_post(request: Request):
    """
    Метод обработчика веб-хук запросов от бота Telegram

    Осуществляет обработку поступающих веб-хук запросов от бота Telegram.
    ...
    голосовых сообщений добавляются как background task и ответ Telegram возвращается немедленно.
